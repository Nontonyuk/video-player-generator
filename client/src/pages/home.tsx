...
export default function Home() {
  ...
  const createPlayerMutation = useMutation({
    mutationFn: async (data: InsertPlayerConfig): Promise<PlayerConfig> => {
      ...
      // Generate iframe code untuk embedding
      const embedCode = `<iframe src="data:text/html;base64,${iframeCode}" width="100%" height="400" frameborder="0" allowfullscreen></iframe>`;
      ...
      return {
        ...
        directLink: `data:text/html;base64,${iframeCode}`,
        createdAt: new Date()
      } as PlayerConfig;
    },
    onSuccess: (config) => {
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    {generatedConfig && (
                      <div style={{ position: 'absolute', top: '5px', right: '5px', display: 'flex', gap: '5px' }}>
                        ...
                        <Button
                          onClick={() => window.open(generatedConfig.directLink, '_blank')}
                          style={{
                            padding: '5px 10px',
                            fontSize: '12px',
                            background: '#179b77',
